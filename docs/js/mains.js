...
const tutorialContent = () => {
    if (document.getElementById("divTutorial") == null) {
        ...
        if(matrixNumber == 2){        
            ...
            let cofactorA13 = matrixValues[2]*((matrixValues[4] * (matrixValues[9] * matrixValues[15]  - matrixValues[11] * matrixValues[13]) + (-matrixValues[5]) * (matrixValues[8] * matrixValues[15] - matrixValues[11] * matrixValues[12]) + matrixValues[7] * (matrixValues[8] * matrixValues[13] - matrixValues[9]  * matrixValues[12])))
            let cofactorA14 = (-matrixValues[3])*((matrixValues[4] * (matrixValues[9] * matrixValues[14]  + (-matrixValues[10]) * matrixValues[13]) + (- matrixValues[5]) * (matrixValues[8] * matrixValues[14] - matrixValues[10] * matrixValues[12]) + matrixValues[6] * (matrixValues[8] * matrixValues[13] - matrixValues[9]  * matrixValues[12])));
            ...
            divTitleH2Content.innerHTML = 
                "𝐴11 = " + matrixValues[0]+"["+matrixValues[5]+"("+matrixValues[10]+"*"+matrixValues[15]+"-"+matrixValues[11]+"*"+matrixValues[14]+") - [" + (matrixValues[6])+"("+matrixValues[9]+"*"+matrixValues[15]+"-"+matrixValues[11]+"*"+matrixValues[13]+")] + " + matrixValues[7]+"("+matrixValues[9]+"*"+matrixValues[14]+"-"+matrixValues[10]+"*"+matrixValues[13] + ")] <br>" +
                 ...
                 "𝐴13 = " + matrixValues[2]+"["+matrixValues[4]+"("+matrixValues[9] +"*"+matrixValues[15]+"-"+matrixValues[11]+"*"+matrixValues[13]+") - [ " + (matrixValues[5])+"("+matrixValues[8]+"*"+matrixValues[15]+"-"+matrixValues[11]+"*"+matrixValues[12]+")] + " + matrixValues[7]+"("+matrixValues[8]+"*"+matrixValues[13]+"-"+matrixValues[9]+"*"+matrixValues[12] + ")] <br>" +
                    "𝐴13 = " + matrixValues[2]+"["+matrixValues[4]+"("+ (matrixValues[9] * matrixValues[15]  - matrixValues[11] * matrixValues[13])+") - [" +(matrixValues[5])+"("+(matrixValues[8] * matrixValues[15] - matrixValues[11] * matrixValues[12])+")] + " + matrixValues[7]+"("+ (matrixValues[8] * matrixValues[13] - matrixValues[9] * matrixValues[12]) + ")] <br>" +
                        "𝐴13 = " + matrixValues[2]+"[("+matrixValues[4] * (matrixValues[9] * matrixValues[15]  - matrixValues[11] * matrixValues[13])+") - (" +(matrixValues[5]) * (matrixValues[8] * matrixValues[15] - matrixValues[11] * matrixValues[12])+") + (" + matrixValues[7] * (matrixValues[8] * matrixValues[13] - matrixValues[9] * matrixValues[12]) + ")] <br>" +
                            "𝐴13 = " + matrixValues[2]+"["+(matrixValues[4] * (matrixValues[9] * matrixValues[15]  - matrixValues[11] * matrixValues[13]) + (-matrixValues[5]) * (matrixValues[8] * matrixValues[15] - matrixValues[11] * matrixValues[12]) + matrixValues[7] * (matrixValues[8] * matrixValues[13] - matrixValues[9]  * matrixValues[12]))+"] <br>"+
                                "𝐴13 = " + cofactorA13 +"<br><br>"+
             
                "𝐴14 = " + (-matrixValues[3])+"["+matrixValues[4]+"("+matrixValues[9] +"*"+matrixValues[14]+"-"+matrixValues[10]+"*"+matrixValues[13]+") - [" + (matrixValues[5])+"("+matrixValues[8]+"*"+matrixValues[14]+"-"+matrixValues[10]+"*"+matrixValues[12]+")] + " + matrixValues[6]+"("+matrixValues[8]+"*"+matrixValues[13]+"-"+matrixValues[9]+"*"+matrixValues[12] + ")] <br>" + 
                   "𝐴14 = " + (-matrixValues[3])+"["+matrixValues[4]+"("+ (matrixValues[9] * matrixValues[14]  - matrixValues[10] * matrixValues[13])+") - [" +(matrixValues[5])+"("+(matrixValues[8] * matrixValues[14] - matrixValues[10] * matrixValues[12])+")] + " + matrixValues[6]+"("+ (matrixValues[8] * matrixValues[13] - matrixValues[9] * matrixValues[12]) + ")] <br> " +  
                       "𝐴14 = " + (-matrixValues[3])+"[("+matrixValues[4] * (matrixValues[9] * matrixValues[14]  - matrixValues[10] * matrixValues[13])+") - (" +(matrixValues[5]) * (matrixValues[8] * matrixValues[14] - matrixValues[10] * matrixValues[12])+") + (" + matrixValues[6] * (matrixValues[8] * matrixValues[13] - matrixValues[9] * matrixValues[12]) + ")] <br>" + 
                           "𝐴14 = " + (-matrixValues[3])+"["+(matrixValues[4] * (matrixValues[9] * matrixValues[14]  + (-matrixValues[10]) * matrixValues[13]) + (-matrixValues[5]) * (matrixValues[8] * matrixValues[14] - matrixValues[10] * matrixValues[12]) + matrixValues[6] * (matrixValues[8] * matrixValues[13] - matrixValues[9]  * matrixValues[12]))+"] <br>"+
